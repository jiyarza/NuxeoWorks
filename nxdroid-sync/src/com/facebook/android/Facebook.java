...
public class Facebook {
    ...
    protected static String RESTVIDEO_URL = 
    ...
    public String request(Bundle parameters) 
        ...
        return request(null, parameters, "GET", null);
    }
    ...
    public String request(String graphPath) 
          throws MalformedURLException, IOException {
        return request(graphPath, new Bundle(), "GET", null);
    }
    ...
    public String request(String graphPath, Bundle parameters) 
          throws MalformedURLException, IOException {
        return request(graphPath, parameters, "GET", null);
    }
    ...
    public String request(String graphPath,
    	...
    	String urlServer = RESTSERVER_URL;
    	if(type != null){
    		if(type.equals(DocumentType.MOVIE))
    			urlServer = RESTVIDEO_URL;
    	}
